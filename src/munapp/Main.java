...
public class Main extends Application {
     ...
     */
    public void saveXMLConfig(File configFile){
    ...
    public void start(Stage primaryStage) throws Exception{
        Parent root = FXMLLoader.load(getClass().getResource("munapp.fxml"));
...
// create the menu bar
        ...
        saveSession.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                File config = fileChooser.showSaveDialog(primaryStage.getScene().getWindow());

                if(config != null) {
                    saveXMLConfig(config);
                }
            }
        });
